        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-16 pt-20">
          <div className="max-w-xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/pest-finder" className="inline-flex items-center gap-2 border border-yellow-400/70 text-yellow-300 hover:bg-yellow-400/10 font-bold px-7 py-3.5 rounded-full transition-all duration-200 text-sm">
                {t('Pest Finder','பூச்சி கண்டுபிடிப்பு')} <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
